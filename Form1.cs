...
namespace laba1
{
    public partial class Form1 : Form
    {
        ...
        private void txtboxA_KeyPress(object sender, KeyPressEventArgs e)
        {
            ...
            if (Char.IsControl(e.KeyChar))
            {
                if (e.KeyChar == (char)Keys.Enter && btnStart2.Enabled) btnStart2.Focus();
                return;
            }
            ...
            if (e.KeyChar == ',')
            {
                if (txtboxA.Text.IndexOf(',') != -1 || txtboxA.Text == "") e.Handled = true;
                return;
            }

            if (e.KeyChar == '-')
            {
                if (txtboxA.Text.IndexOf('-') != -1 || txtboxA.SelectionStart != 0) e.Handled = true;
                return;
            }
        ...
        private void txtboxY_KeyPress(object sender, KeyPressEventArgs e)
        {
            if ((e.KeyChar >= '0') && (e.KeyChar <= '9')) return;
        ...
        private void txtBox3A_KeyPress(object sender, KeyPressEventArgs e)
        {
            if ((e.KeyChar >= '0') && (e.KeyChar <= '9')) return;
        ...
        private void txtBox3B_KeyPress(object sender, KeyPressEventArgs e)
        {
            if ((e.KeyChar >= '0') && (e.KeyChar <= '9')) return;
        ...
        private void txtBox3C_KeyPress(object sender, KeyPressEventArgs e)
        {
            if ((e.KeyChar >= '0') && (e.KeyChar <= '9')) return;
        ...
        private void txtBox3D_KeyPress(object sender, KeyPressEventArgs e)
        {
            if ((e.KeyChar >= '0') && (e.KeyChar <= '9')) return;
        ...
        private void txtBox4A_KeyPress(object sender, KeyPressEventArgs e)
        {
            if ((e.KeyChar >= '0') && (e.KeyChar <= '9')) return;
        ...
        private void txtBox4B_KeyPress(object sender, KeyPressEventArgs e)
        {
            if ((e.KeyChar >= '0') && (e.KeyChar <= '9')) return;
        ...
        private void txtBox4C_KeyPress(object sender, KeyPressEventArgs e)
        {
            if ((e.KeyChar >= '0') && (e.KeyChar <= '9')) return;
        ...
        private void txtBox6A_KeyPress(object sender, KeyPressEventArgs e)
        {
            if ((e.KeyChar >= '0') && (e.KeyChar <= '9')) return;
        ...
        private void txtBox6B_KeyPress(object sender, KeyPressEventArgs e)
        {
            if ((e.KeyChar >= '0') && (e.KeyChar <= '9')) return;
        ...
        private void txtBox7A_KeyPress(object sender, KeyPressEventArgs e)
        {
            if ((e.KeyChar >= '0') && (e.KeyChar <= '9')) return;
